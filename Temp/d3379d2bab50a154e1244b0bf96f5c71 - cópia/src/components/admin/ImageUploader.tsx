...
interface ImageUploaderProps {
  ...
  uploadDir?: string; // optional subfolder: 'logos', 'banners', 'products', etc.
}

const ImageUploader: React.FC<ImageUploaderProps> = ({ onImageUpload, uploadDir }) => {
  ...
  const handleFile = useCallback((file: File | null) => {
    ...
    form.append('dir', uploadDir || 'general');
    fetch('/api/upload.php', { method: 'POST', body: form })
      .then(async res => {
